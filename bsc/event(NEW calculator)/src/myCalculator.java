...
public class myCalculator 
{
	public static void main(String args[]) 
	{
		...
		enter.setBounds(50,510,190,50); l2.setBounds(250,510,250,30);
	  ...
	  class enterval implements ActionListener
	 {
		  float e1;
		  float e2;
		public void actionPerformed(ActionEvent e)
		{
			if(e1==0.0)
			{
			e1=Float.parseFloat(t1.getText());
			l2.setText("NOTE: Sucessfully enterer->" +e1);
			}
			else
			{
				e2=Float.parseFloat(t1.getText());
				l2.setText("NOTE: Sucessfully enterer->" +e2);
			}
			t1.setText("MESSAGE : data1= "+e1+"data2= "+e2);
		}
		
	}
	 ActionListener obj= new enterval();
